...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <h1>Shape Your College's Future</h1>
            <p>Your vote is your voice. Join thousands of students in making decisions that matter. Participate in the democratic process and help build a better campus community.</p>
            <button class="cta-button">Start Voting Now</button>
        </div>
    </section>
    ...
    <section class="features">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <h3>Secure Voting</h3>
                <p>State-of-the-art encryption ensures your vote remains confidential and tamper-proof.</p>
            </div>
            <div class="feature-card">
                <i class="fas fa-mobile-alt"></i>
                <h3>Vote Anywhere</h3>
                <p>Cast your vote from any device, anywhere on campus or at home.</p>
            </div>
            <div class="feature-card">
                <i class="fas fa-chart-line"></i>
                <h3>Live Results</h3>
                <p>Watch real-time election results and statistics as they unfold.</p>
            </div>
        </div>
    </section>
